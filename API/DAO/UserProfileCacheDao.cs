...
public class UserProfileCacheDao(ISqlConnectionFactory factory) : IUserProfileCacheDao
{
    ...
    /// <summary>
    /// Deletes all user profile cache entries associated with the specified provider user identifier.
    /// </summary>
    /// <param name="providerUserId">The provider user identifier whose user profile cache entries should be deleted.</param>
